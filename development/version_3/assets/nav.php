...
echo "<li> <a href='ev_charger.php'>EV Chargers</a></li>"; //link to EV chargers page
echo "<li> <a href='smart_home.php'>Smart Meters</a></li>"; //link to smart meter page
echo "<li> <a href='solar.php'>Solar Panels</a></li>"; //link to solar panels page
