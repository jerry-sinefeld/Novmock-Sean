...
if (isset($_SESSION['enginid'])) {//checks if user is already logged in if so it directs you to the index page
    ...
    if ($staff ) {
        $_SESSION['enginid'] = true;
        $_SESSION['enginid'] = $staff['enginid'];
        $_SESSION['usermessage'] = "You are logged in";
        auditor(dbconnect_insert(), $_SESSION['enginid'], "log", "Engineer has logged in");
